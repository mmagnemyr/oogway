param (
    [string]$fullpath = "solution.xlsx"
)

$filenameWithExtension = Split-Path $fullpath -Leaf

$buildpath = Join-Path $PSScriptRoot "/../build"
$fullpath=Join-Path $buildpath $filenameWithExtension

# Create a new Excel application object
$excel = New-Object -ComObject Excel.Application
$excel.Visible = $false  # Set to $true if you want Excel to be visible during the process
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUC5Cz20vrZ9t1rtZSaot3q2u0
# BKugghX/MIIC8jCCAdqgAwIBAgIQHlsuCbF3KYFDb2+p7pMvjTANBgkqhkiG9w0B
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJ27Rc42Y2nI
# PU1UDT/r1ziju8dRMA0GCSqGSIb3DQEBAQUABIIBAE8rTaNTrR6ygoeprB/49fBT
# bVmx58pfIVmAYwp/d7VFz5LxQ5MSrWwivPvx1zxX9Ewmpuu/el7/cugiHsgjHZYF
# +ZwyggUc6OyFKxsKNdmf3o6EWb657TBD3964gUWKLMmklBq5mbrh6IsATTDZDG37
# fR2WOW5dfT/d7toOFBgr1ucxmdxjCnBW+00ZihX07abYPdSIr8RreF2q9MBqfAad
# sDoFNURfuqbFQGddxlCsySjaa9Dwk6Y9UU6eFiUBpMZ3m48HVHKmX36yOFbzeDZm
# nEG0qyqAuEsiA5w7MOxX0+SK4oknFAwxGV8IKXJ1EtS8KaxIbglw1+nxNckzTNah
...
# ATAcBgkqhkiG9w0BCQUxDxcNMjQwMTI1MTQxMzI4WjAvBgkqhkiG9w0BCQQxIgQg
# CjNkEYcSB25ZcSYqeOYgWiQnNZMpZBXU1xPSyBRECeowDQYJKoZIhvcNAQEBBQAE
# ggIABb6zoRjnvkhwKnJkHoqIs6syTYJaO/7/6zNF7K/D6/fCozNDOAvLfaUVJHiw
# m58Wsmsjcmf+ejeQQS12b0w0H6qv3/LKkBsec8GJRuNMOphlMF1a6Qiz6550/JvS
# th83jWFBaY8NdBGQ4zS8cdKshLS2B3VVBHMmJCWyxthfC9HoCyAzC1dpwNppqA//
# DtqXZP0lvs2H9F+4oFj3uCTVjaavauyeYO1Yx1jZLhDdKdPtLVAgtO+KvJNa319Z
# vTWm3G1qjgBPVa0mmA7b7ImF9sZwt0tnT05N1pkCacJTrZbinRBa3uo78TtvVM/b
# djkNGmxfB4E8ne54JVKEtKjiFgR9fpE/eRzw4TBcIrFu5QZyLBR9hmwMjAxZsDSz
# 0PkrLIG2UAeVdMQWdGvo2LSTaO1VTnjLB0pWhLt2Xzxs+6o5O2kYJ1wlPrl6N4oF
# kQ93iMqqO17q8OnSo2XpCJ0a8Um+/ZsB6DFstixYln47qwqAUBnWtq9FCNasRPR1
# WNOrqc0wfYoWhEcsQ1uYe4Zu+OV/SiHvfNgpgpjLI3lw9eMx3a0UVLOWl9bFdxgF
# qs2Hwc86SbnshpTnNEpk8bXJgxsXSSqCPVnCmXyLXxleBVVL1oPbgwZGMPnjw65h
# m4WO9ar/FhYzU0TzU4lxsvcd3/mXKX4l+K4Oj+83dOLG6jk=
